...
When we have a model fit on 3d data but want to visualize it in 1d, you can use:
...
Now, trying `plot_3d` out on some synthetic data and estimated model.
...
## Later when |flowtrend()| is developed, we can do this:
...
##                 niter = 50,
##                 nrestart = 1)
## plot_3d(ylist = datobj$ylist, tt = 30, obj = obj, bin = FALSE)
```
