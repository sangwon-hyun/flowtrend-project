...
![Cross-validated model estimates (on *evenly* spaced data).](inst/cv-offline-test.png)

(The dashed black lines are the truth, and the solid colored lines are the estimated means.)


## CV produces too many files? No problem
...
![Cross-validated model estimates on unevenly spaced data.](inst/uneven-spaced-data-test.png)
